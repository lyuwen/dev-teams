...
- A testing decision is made that future tasks should follow (frameworks, coverage expectations, test patterns)
- You discover a project constraint, convention, or pattern worth preserving
- You receive feedback on your output (test style, coverage approach)
